...
@DisplayName("Vertex Coordinate Object Tests")
class VertexCoordinateTests {
    ...
    @Nested
    @DisplayName("Vertex Coordinate's Getter Tests")
    class GetterTests {
        @Test
    ...
    @Nested
    @DisplayName("Vertex Coordinate's Equals Tests")
    class EqualsTests {
        @Test
        ...
        void equals_DifferentType() {
            ...
            assertNotEquals(vertex, notAVertex, "equals should return false when comparing with a different type.");
        }

        @Test
        @DisplayName("equals returns true for objects with nearly equal coordinates")
        ...
        @Test
        @DisplayName("equals returns false for objects with different coordinates")

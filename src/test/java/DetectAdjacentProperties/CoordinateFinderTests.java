...
@DisplayName("Coordinate Finder Tests")
class CoordinateFinderTests {

    @Nested
    @DisplayName("Coordinate Finder's Valid Input Tests")
    ...
    @Nested
    @DisplayName("Coordinate Finder's Empty and Null Input Tests")
    ...
    @Nested
    @DisplayName("Coordinate Finder's Partial Data Handling Tests")
    class PartialDataTests {
        ...
        void findMaxCoordinates_skipsNulls() {
            ...
            List<PropertyPolygon> properties = Arrays.asList(null, p2, p3, p4);

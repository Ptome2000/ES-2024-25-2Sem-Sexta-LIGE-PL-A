...
/**
 * This class provides methods to find the maximum and minimum coordinates (X and Y) from a list of PropertyPolygon objects.
 * It iterates through the vertices of each property polygon and identifies the highest and lowest X and Y values.
 */
